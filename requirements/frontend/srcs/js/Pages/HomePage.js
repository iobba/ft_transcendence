...
export default class HomePage extends ParentPage {

  constructor(singlePageApp) {
    super('Home');
    this.locationList = [`home`, ``];
    this.hasAToken = true;
    this.needToken = true;
  }
    ...
    return `
      <div class="container-fluid align-items-center justify-content-center">
						...
						<!-- <div class="row">
							...
							<div class="col d-flex justify-content-center align-items-center flex-column flex-wrap">
            ...
            <div class="row p-0 m-0">
              <div class="col d-flex justify-content-around align-items-center flex-wrap gap-3">
                <div class="card show-card">
                  <div class="card-body">
                    <img src="/img/card_game.png" style="position: absolute; z-index: -1; right: 0; height: 100%">										
                    <h5 class="card-title">
                      Game
                    </h5>
                    <h6 class="card-subtitle mb-2 text-muted">Let's play now</h6>
                    <p class="card-text">Play against opponents from around the world in our fast-paced online Ping Pong game.</p>
                    <a href="/game" class="card-link" local-link>Play Now</a>
                  </div>
                </div>
                <div class="card show-card">
                  <div class="card-body">
                    <img src="/img/card_profile.png" style="position: absolute; z-index: -1; right: 0; height: 100%">										
                    <h5 class="card-title">Profile</h5>
                    <h6 class="card-subtitle mb-2 text-muted">Ping pong profile page!</h6>
                    <p class="card-text">Showcase your skills, matches, achievements, and stats in this dynamic web platform.</p>
                    <a href="/profile" class="card-link" local-link>My Profile</a>
                    <!-- <a href="#" class="card-link">Another link</a> -->
                  </div>
                </div>
                <div class="card show-card">
                  <div class="card-body">
                    <img src="/img/card_leaderbord.png" style="position: absolute; z-index: -1; right: 0; height: 100%">										
                    <h5 class="card-title">leaderbord</h5>
                    <h6 class="card-subtitle mb-2 text-muted">Are you ready to dominate the game?</h6>
                    <p class="card-text">Discover the top players in this thrilling online game. Compete, improve your skills, and climb your way to the pinnacle of Ping Pong greatness.</p>
                    <a href="/leaderbord" class="card-link" local-link>Leaderbord</a>
                    <!-- <a href="#" class="card-link">Another link</a> -->
                  </div>
                </div>
              </div>
  ...
  createPodiumCard(index) {
    ...
    return `<a local-link href="/user?id=${this.data[index].id}" alt="@${this.data[index].username}" style="text-decoration: none; display: flex; gap: 0.5rem; align-items: center; justify-content: flex-start; flex-direction: column;" class="">
